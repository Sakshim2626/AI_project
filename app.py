...
# Load scaler
scaler = pickle.load(open(r"C:\Users\ADMIN\Desktop\AI_project\sakshi\models\scaler.pkl", 'rb'))

# Load model
model = pickle.load(open(r"C:\Users\ADMIN\Desktop\AI_project\sakshi\models\model.pkl", 'rb'))
